...
/**
 * Tests {@link StringToClassInstance}. Not all error conditions of
 * the decoding method are tested (in particular, there aren't test
 * cases that very behavior when unusual exceptions are thrown during
...
public class StringToClassInstanceTest {
    ...
    public void constructionOnInterfaceThrows() {
		...
		final StringToClassInstance<? extends Interface> converter = new StringToClassInstance<Interface>(Interface.class);
    }

    @Test(expected = IllegalArgumentException.class)
    public void constructionOnAbstractClassThrows() {
        @SuppressWarnings("unused")
		final StringToClassInstance<? extends Interface> converter = new StringToClassInstance<AbstractClass>(AbstractClass.class);
    }

    @Test(expected = IllegalArgumentException.class)
    public void constructionOnNoSingleStringConstructorThrows() {
        @SuppressWarnings("unused")
		final StringToClassInstance<? extends Interface> converter = new StringToClassInstance<NoStringConstructorClass>(NoStringConstructorClass.class);
    }

    @Test
    public void constructionOnSingleStringConstructor() {
        @SuppressWarnings("unused")
		final StringToClassInstance<? extends Interface> converter = new StringToClassInstance<StringConstructorClass>(StringConstructorClass.class);
    }
    ...
    public void decodingThrowingConstructorThrows() {
        final StringToClassInstance<? extends Interface> converter = new StringToClassInstance<ThrowingStringConstructorClass>(ThrowingStringConstructorClass.class);
