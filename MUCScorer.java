 ...
 *
 * See Marc Vilain, John Burger, John Aberdeen, Dennis Connolly, and Lynette Hirschman. 1995.
...
public final class MUCScorer {
     ...
     * @return
     */
    public Optional<FMeasureInfo> score(final Iterable<? extends Iterable<?>> predicted, final Iterable<? extends Iterable<?>> gold) {
        ...
        final Optional<Float> recall = mucScoreComponent(goldAsSets, predictedAsSets, predictedItemToGroup);
        final Optional<Float> precision = mucScoreComponent(predictedAsSets, goldAsSets, goldItemToGroup);
    ...
    private Optional<Float> mucScoreComponent(List<Set<Object>> leftClustering, List<Set<Object>> rightClustering,
