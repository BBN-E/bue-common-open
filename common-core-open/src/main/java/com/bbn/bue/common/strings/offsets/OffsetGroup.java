...
public final class OffsetGroup {
	private OffsetGroup(final ByteOffset byteOffset, final CharOffset charOffset, final EDTOffset edtOffset, final ASRTime asrTime) {
...
/*	@Deprecated
    ...
    /**
     * Creates an offset group using the same offset value as both the
     * {@link com.bbn.bue.common.strings.offsets.CharOffset} and
     * {@link com.bbn.bue.common.strings.offsets.EDTOffset}. This is for
     * unit testing purposes and probably shouldn't be used in other code.
     * @param offset
     * @return
     */
	...
	public static OffsetGroup from(final ByteOffset byteOffset, final CharOffset charOffset, final EDTOffset edtOffset) {
	...
	public Optional<ByteOffset> byteOffset() { return Optional.fromNullable(byteOffset); }
	public CharOffset charOffset() { return charOffset; }
	public EDTOffset edtOffset() { return edtOffset; }
	public Optional<ASRTime> asrTime() { return Optional.fromNullable(asrTime); }
