...
public final class DoubleUtils {
	private DoubleUtils() { throw new UnsupportedOperationException(); }
	...
	/**
	 * Returns the index of the first minimal element of the array. That is, if there is
	 * a unique minimum, its index is returned. If there are multiple values tied for
	 * smallest, the index of the first is returned. If the supplied array is empty,
	...
	/**
	 * Returns the index of the first minimal element of the array within the specified bounds. That is, if there is
	 * a unique minimum, its index is returned. If there are multiple values tied for
	 * smallest, the index of the first is returned. If the supplied array is empty,
	 * an {@link IllegalArgumentException} is thrown.
	 */
	...
	/**
	 * Returns the index of the first maximal element of the array. That is, if there is
	 * a unique maximum, its index is returned. If there are multiple values tied for
	 * largest, the index of the first is returned. If the supplied array is empty,
	 * an {@link IllegalArgumentException} is thrown.
	 */
	...
	/**
	 * Returns the index of the first maximal element of the array within the specified bounds. That is, if there is
	 * a unique maximum, its index is returned. If there are multiple values tied for
	 * largest, the index of the first is returned. If the supplied array is empty,
	 * an {@link IllegalArgumentException} is thrown.
	 */
	...
	/**
	 * Returns the maximum value in the array within the specified bounds. If
	 * the supplied range is empty or invalid, an {@link IllegalArgumentException} is thrown.
	 */
