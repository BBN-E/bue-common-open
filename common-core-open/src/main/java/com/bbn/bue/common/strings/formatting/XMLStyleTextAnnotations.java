...
public final class XMLStyleTextAnnotations {
	...
	public static AnnotatedOffsetRange<CharOffset> createDiv(final String clazz, final OffsetRange<CharOffset> span) {
		return AnnotatedOffsetRange.create(DIV, span,
                ImmutableMap.<String, String>of("class", clazz));
	}

	public static AnnotatedOffsetRange<CharOffset> createSpan(final String clazz, final OffsetRange<CharOffset> span) {
		return AnnotatedOffsetRange.create(SPAN, span,
                ImmutableMap.<String, String>of("class", clazz));
	}

    public static AnnotatedOffsetRange<CharOffset> createSpanWithID(final String clazz, final String id,
	...
	public static AnnotatedOffsetRange<CharOffset> createDivWithID(final String clazz, final String id,
                                           final OffsetRange<CharOffset> span)
    {
		checkNotNull(id);
