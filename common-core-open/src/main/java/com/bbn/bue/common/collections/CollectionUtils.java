...
public final class CollectionUtils {
	...
	/**
	 * Returns a new Multiset resulting from transforming each element of the input Multiset by a function.
	 * If two or more elements are mapped to the same value by the function, their counts will be
	 * summed in the new Multiset. 
	 * @param ms
	 * @param func
	 * @return
	 */
	...
	/**
	 * Gets a sublist of a list, truncated at the end of the list if too many
	 * elements are selected.  This behaves exactly like List.subList, including
	 * all notes in its Javadoc concerning structural modification of the backing
	 * List, etc. with one difference: if the end index is beyond the end of the 
	 * list, instead of throwing an exception, the sublist simply stops at the end of
	 * the list.  After the fifth or so time writing this idiom, it seems worth having
	 * a function for. :-)
	 */
    ...
    /**
     * Returns true if and only if all the collections in the provided list have the
     * same size. Returns true if the provided list is empty.
     *
     * @param collections
     * @return
     */
