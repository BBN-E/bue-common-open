...
public final class FMeasureCounts extends FMeasureInfo {
	...
	public float truePositives() { return truePositives; }
	public float falsePositives() { return falsePositives; }
	public float falseNegatives() { return falseNegatives; }
	public float numPredicted() { return truePositives() + falsePositives(); }
	...
	public String compactPrettyString () {
		return String.format("TP: %.2f, FP: %.2f, FN: %.2f; P: %3.2f; R: %3.2f; F: %3.2f",
			truePositives, falsePositives, falseNegatives, 100.0*precision(), 100.0*recall(), 100.0*F1());
	}
	...
	@Beta
	public static <T> Map<T, FMeasureCounts> fromLabels(final List<T> goldLabels, final List<T> predictedLabels) {
	...
	public static <T> FMeasureCounts fromHashableItems(final Set<T> predictedPositiveItems, final Set<T> allPositiveItems) {
