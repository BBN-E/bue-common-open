...
public final class EREtoAPF {
  ...
  private static APFRelation toAPFRelation(final ERERelation relation, 
  ...
  private static ImmutableList<APFRelationMention> toAPFRelationMentions(final ImmutableList<ERERelationMention> relationMentions,
  ...
  private static APFRelationMention toAPFRelationMention(final ERERelationMention ereRelationMention, 
      final Map<String, Object> idMap) {
