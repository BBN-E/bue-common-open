...
public final class EREtoACETypeMapper {
  ...
  private final ImmutableMap<String, String> ereRelation2tacSlot;
  ...
  private EREtoACETypeMapper(final Map<String, String> eventTypes, final Map<String, String> eventSubtypes,
      ...
      final ImmutableMap<String, String> ereRelation2tacSlot) {
    ...
    this.ereRelation2tacSlot = ImmutableMap.copyOf(ereRelation2tacSlot);
  }
  ...
  public static EREtoACETypeMapper from(final Parameters params) throws IOException {
    ...
    final ImmutableList<String> fillerLines = linesFromResourceFile(
        params.getString("ereToAce.filler.mappings"));
    ...
    // mappings from ERE relations/events to TAC slots
    final ImmutableList<String> relationLines = linesFromResourceFile(
        params.getString("ERErelationToTACslot.mappings"));
    final ImmutableMap<String, String> ereRelation2tacSlot = mapERErelation2TACslot(relationLines);
    //
  ...
  public Optional<String> mapERErelationSubTypeToTACslot(String ereRelation) {
    if(ereRelation2tacSlot.containsKey(ereRelation))
      return Optional.of(ereRelation2tacSlot.get(ereRelation));
    else
  ...
  private static ImmutableMap<String, String> mapERErelation2TACslot(final ImmutableList<String> lines) {
    final ImmutableMap.Builder<String, String> ret = ImmutableMap.builder();

    for(final String line : lines) {
      final String[] items = line.split(" ");
      String ereRelationSubType = items[0];
      String tacSlot = items[1];

      ret.put(ereRelationSubType, tacSlot);
    }
